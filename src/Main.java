...
public class Main {
    public static void main(String[] args) {
        ...
        saveGame("F://Games/savegames/game1.dat", game1);
        saveGame("F://Games/savegames/game2.dat", game2);
        saveGame("F://Games/savegames/game3.dat", game3);
        ArrayList<String> arrayList = new ArrayList<>();
        arrayList.add("F://Games/savegames/game1.dat");
    ...
    private static void zipFiles(String path, List<String> arrayList){
        try (ZipOutputStream zout = new ZipOutputStream(new FileOutputStream(path))) {
            for (String lst : arrayList) {
                try (FileInputStream fis = new FileInputStream(lst)) {
                    ZipEntry entry = new ZipEntry(lst);
